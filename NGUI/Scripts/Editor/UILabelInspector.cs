...
public class UILabelInspector : UIWidgetInspector
{
	...
	protected override bool ShouldDrawProperties ()
	{
        ...
        NGUIEditorTools.DrawProperty("Exchange",serializedObject, "isNeedChange", GUILayout.MinWidth(30f));
        GUILayout.EndHorizontal();
        //NGUIEditorTools.drawp(serializedObject, "isNeedChange", GUILayout.MinWidth(40f));
        GUILayout.BeginHorizontal();
#if DYNAMIC_FONT
